...
return {
conversation: 'WhatsApp Bot By YupzPlazaaa'
}}})
	
if (pairingCode && !Sky.authState.creds.registered) {
let phoneNumber
phoneNumber = await question(chalk.blue.bold('Masukan Nomor WhatsApp Dengan Awal-an 62 :\n'))
...
if (connection == 'open') {
Sky.sendMessage(Sky.user.id.split(":")[0] + "@s.whatsapp.net", {text: `${`*#- YUPZ ASSISTEN*

Jangan lupa untuk SV NO ATMINN -> 6281390930615 sehingga Anda bisa mendapatkan update terbaru tentang ini script :)`.toString()}`})
console.log(chalk.blue.bold(`YuPzz boot Connected ✓\n\n`))
randomToken(Sky)
