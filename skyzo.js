...
await conn.sendMessage(m.chat, {
  footer: `Support Dengan Buy Script, Hanya Rp 10.000.00 (10K)`,
  buttons: [
    {
      buttonId: `.allmenu`,
...
paramsJson: JSON.stringify({
  title: 'Script Bot Yuaa 🚀',
  sections: [
    {
title: 'Kuy Beli Boleh Nego Lohh!!',
highlight_label: 'Gass Buyy!!',
rows: [
  {
    header: '',
    title: 'BUY SCRIPT DENGAN HARGA Rp 10.000.00',
    description: 'Mau Simpel Langsung Ke Owner Saja https://wa.me/6281390930615',
    id: '.buysc',
  },
  {
    header: '',
...
╰─────────────···`
await conn.sendMessage(m.chat, {
  footer: `Support Dengan Cara Buy Script🍁`,
  buttons: [
    {
      buttonId: `.menu`,
    ...
    nativeFlowInfo: {
        ...
        paramsJson: JSON.stringify({
          ...
          sections: [
            {
              title: 'Yok Biy Sc Hanya 10k Saja Loo!!',
              highlight_label: 'Kebutuhan lainnya & tentang bot',
              rows: [
                {
                ...
                {
                  title: 'Script Bot WhatsApp (Yua Assisten🚀)',
                  id: '.buysc'
                }
              ]
            }
...
await fetchJson("https://api.skyzopedia.us.kg/api/ai/openai-prompt?prompt=Sekarang Kamu Adalah Yuaa Asissten dan selalu gunakan bahasa Indonesia saat menjawab semua pertanyaan&msg=" + talk).then(async (res) => {
...
let Obj = {}
    ...
    if (tek == "1") {
    Obj.file = "./source/media/YupzBotz.zip"
    Obj.harga = "15000"
    Obj.namaSc = "Script Turzz Botz V6"
    } else if (tek == "2") {
...
var name = `Simple-Bot-by-yupzzplazaa`
